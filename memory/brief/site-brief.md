...
- **site_url:** `https://www.xn--80aaoqxlidb0d.xn--p1ai/` (IDN: https://www.таросейчас.рф/) — публичный, не секрет
...
- Wordstat: Yandex Cloud Search API v2, folderId `[REDACTED]` (ключ только в Secrets).
...
- **reference:** `memory/cover/assets/Виктория.png` (канон Виктория.png; не viktoriaref.png)
