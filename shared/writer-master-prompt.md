...
- Воронка: расклад (триплет / кельтский крест, 3 вопроса, голос или текст) только
  ...
  уточнения только через приложение (в Дзене ссылка на ВК; приложение Макс
  можно назвать без URL). Нельзя писать «хочешь Суть–Тень–Вектор — иди в бот».
  Один абзац — один продукт. Telegram в Дзен-статье не писать.
