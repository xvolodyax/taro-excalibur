...
3. Перепиши **целиком** в слог тенанта:
   ...
   - **лид:** живая сцена из Writer/research; опереться на неё
     («Разберём этот конкретный пример…») — не «Возьмём:» / «кейс»,
     не часы B23, не гейт сайта (INC-20260831-0650);
   - **практика:** сохрани или напиши H2 «Практика: чеклист шагов…»
     из маркеров Writer/research этой статьи (не выдумывай шаги);
