...
3. Перепиши **целиком** в слог тенанта:
   ...
   - **вечерний слот:** сохрани или напиши H2 «Практика: чеклист шагов…»
     из маркеров Writer/research этой статьи (не выдумывай шаги).
     В конце лида можно опереться на факты сцены («Разберём этот
     конкретный пример…») — не ярлык «Возьмём:» и не часы B23;
